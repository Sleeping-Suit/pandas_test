...
# csv 파일 읽어오기
bream_length = pd.read_csv('C:/workspace/testcsv/fish/bream_length.csv', header= None)
bream_weight = pd.read_csv('C:/workspace/testcsv/fish/bream_weight.csv', header= None)
smelt_length = pd.read_csv('C:/workspace/testcsv/fish/smelt_length.csv', header= None)
smelt_weight = pd.read_csv('C:/workspace/testcsv/fish/smelt_weight.csv', header= None)
...
def getTests():
    tests = np.hstack((test_target, test_input))
    tests_DataFrame = pd.DataFrame(tests, columns=["test_target", "test_length", "test_weight"])
